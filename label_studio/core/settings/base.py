...
# CIPH3R Environment Variables

CHUNK_SIZE = get_env('CHUNK_SIZE', 1024 * 1024 * 5)
ANONYMIZATION_API_BASE_URL = get_env('ANONYMIZATION_API_BASE_URL', 'http://localhost:8011')
ANONYMIZATION_API_KEY = get_env('ANONYMIZATION_API_KEY', 'demo')
ANONYMIZATION_CLIENT_KEY = get_env('ANONYMIZATION_CLIENT_KEY', 'demo')
ANONYMIZE_TASKS_TEXT = get_bool_env('ANONYMIZE_TASKS_TEXT', True)